...
class TestDistanceToDestinationFinder(unittest.TestCase):
    ...
    def test_part1_R2_L3(self):
        test_input = "R2, L3"
        finder = DistanceToDestinationFinder(test_input)
        self.assertEqual(5, finder.get_shortest_path_using_whole_input())
        
    def test_part1_R2_R2_R2(self):
        test_input = "R2, R2, R2"
        finder = DistanceToDestinationFinder(test_input)
        self.assertEqual(2, finder.get_shortest_path_using_whole_input())

    def test_part1_R5_L5_R5_R3(self):
        test_input = "R5, L5, R5, R3"
        finder = DistanceToDestinationFinder(test_input)
        self.assertEqual(12, finder.get_shortest_path_using_whole_input())
    ...
    def test_part1_with_puzzle_input(self):
        ...
        finder = DistanceToDestinationFinder(test_input)
        self.assertEqual(262, finder.get_shortest_path_using_whole_input())
